...
plot(febplotdata$CDate,as.numeric(febplotdata$Voltage),xlab="datetime",ylab="Voltage",type = "l")
...
plot(febplotdata$CDate,as.numeric(febplotdata$Global_reactive_power)/500,xlab="datetime",ylab="Global_reactive_power",type = "l")
dev.off()
